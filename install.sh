...
# 1. Check for root/sudo privileges if needed, or install locally
if [ "$EUID" -eq 0 ]; then
...
# 5. Create Desktop Menu Shortcut Entry
...
echo "You can now find 'DuckyISO' in your Linux Mint application menu, or run it via terminal: python3 $INSTALL_DIR/ducky_iso.py"
